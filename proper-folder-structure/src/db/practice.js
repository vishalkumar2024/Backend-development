...
const connections = async () => {
    try {
        ...
        console.log(`\n MongoDB is connected Successfully | DB_host = ${connectionInstence.connection.host} | DB_port = ${connectionInstence.connection.port} | DB_name = ${connectionInstence.connection.name}\n`) // mongoose.connections is basically an array that stores all the active connection objects that Mongoose currently has open.This array contains [host, port, name, readyState ]
